...
import { View, Image,Text,Linking,Platform, Alert, ImageBackground } from 'react-native';
...
const Info = (props)=>{
    ...
    return(
        <View style={styles.container}>
             <LinearGradient colors={['#F5FFFA', '#FFF5EE']}
             ...
             <ImageBackground source = {background} style={{flex:1}}>
                <View style={{alignItems:"center"}}>
                    ...
                    <Button color = "#FFFAF0" icon="eye" mode="contained" onPress={() => {props.navigation.navigate("ViewImage",{picture})}}>
                        Xem ảnh
                    </Button>
                    <Text style={{
                        paddingTop:10,
                ...
                <View style={{flexDirection:'row',padding:10,justifyContent:'space-around'}}>
                    <Button color = "#FFFAF0" icon="account-edit" mode="contained" onPress={() => {props.navigation.navigate("Create",
                    {_id,name,buyer,picture,seller,address,timestamp,totalcost})}}>
                        Chỉnh sửa
                    </Button>
                    <Button color = "#FFFAF0" icon="delete" mode="contained" onPress={() => AlertDelete()}>
                        Xóa
                    </Button>
                </View>
             </ImageBackground>
